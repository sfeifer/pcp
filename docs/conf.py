...
latex_documents = [
    (root_doc, 'pcp.tex', 'pcp Documentation',
     'Performance Co-Pilot', 'manual'),
]
...
man_pages = [
    (root_doc, 'pcp', 'pcp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (root_doc, 'pcp', 'pcp Documentation',
     author, 'pcp', 'One line description of project.',
     'Miscellaneous'),
]
